...
| providers | string[] | Buy-order provider keys to include. Repeat to pass multiple, e.g. `providers=steam&providers=buff163`. One of: `buff163`, `buffmarket`, `c5`, `csfloat`, `dmarket`, `ecosteam`, `marketcsgo`, `steam`, `waxpeer`, `whitemarket`, `youpin`. |
...
| providers | string[] | Buy-order provider keys to include. If omitted, queries all buy-order providers. One of: `buff163`, `buffmarket`, `c5`, `csfloat`, `dmarket`, `ecosteam`, `marketcsgo`, `steam`, `waxpeer`, `whitemarket`, `youpin`. |
