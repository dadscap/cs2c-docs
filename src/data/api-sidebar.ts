...
export const sidebarGroups: SidebarGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { method: "GET", label: "/account/sub-keys", href: "/api-reference/account#list-sub-keys" },
      { method: "POST", label: "/account/sub-keys", href: "/api-reference/account#create-sub-key" },
      { method: "GET", label: "/account/sub-keys/{key_id}", href: "/api-reference/account#get-sub-key" },
      { method: "PATCH", label: "/account/sub-keys/{key_id}", href: "/api-reference/account#update-sub-key" },
      { method: "DELETE", label: "/account/sub-keys/{key_id}", href: "/api-reference/account#delete-sub-key" },
      { method: "POST", label: "/account/sub-keys/{key_id}/reissue", href: "/api-reference/account#reissue-sub-key" },
